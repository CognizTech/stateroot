...
fn seed_registrations(home: &Path) {
    ...
    std::fs::write(
        home.join(".pi/agent/extensions/stateroot.ts"),
        "// Auto-generated by `stateroot install` — // stateroot managed.\nexport default function StaterootExtension() {}\n",
    )
    .unwrap();
}
